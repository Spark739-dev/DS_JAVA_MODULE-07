...
## Algorithm
    ...
    1. Start the program.
    2. Parse the input string into a nested structure using a stack.
    3. Recursively flatten the nested lists into a single list.
    4. Use an iterator with a pointer to return elements sequentially.
    5. Output the final flattened list.
    6. Stop the program.
...
<img width="966" height="262" alt="image" src="https://github.com/user-attachments/assets/42f208fb-aea2-4822-b2d3-cceb277ab1cf" />
